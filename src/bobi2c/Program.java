...
public class Program {
	...
	public static void main(String[] args) {
		...
		try {
			...
			I2CDevice writeDevice = i2c.getDevice(writeAddress);
			I2CDevice readDevice = i2c.getDevice(readAddress);
			while(true) {
				try	{
					writeDevice.write(TAKE_READING);
					Thread.sleep(80);
					readDevice.read(buffer, 0, 2);
